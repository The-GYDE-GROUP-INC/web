              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                <div className='gap-6 flex flex-col min-h-[500px]'>
                  ...
                  <TabPanel value={values.step} index={3}>
                    ...
                    <p className='text-sm'>This step is part of a demo, showcasing a mock use case.</p>
                  </TabPanel>
                  ...
                  {values.step !== 4 && (
                    <div className='flex-grow flex items-end'>
                      <Button onClick={() => setFieldValue('step', values.step + 1)} disabled={!isValid} type='button' className='p-3 w-full'>
